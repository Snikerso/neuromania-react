    ...
    return (
        <>
            <div style={{ padding: 10 }}  >
                <div>
                    <h2 style={{ textAlign: "center", padding: 20, }}>About Us</h2>
                    <p style={{ letterSpacing: 1, }}>
                        Welcome to the first international edition of the Neuromania Conference.
                        <br /><br />

                        Have you ever wondered what visual imagery is? We did, it seems that the capacity to imagine varies greatly between individuals (Crawford WInlove). But wait... What about  imagining in different modalities? How do blind people imagine? How do blind people think abstractly? (Roberto Bottini) Speaking of which, what actually might “thinking” be? Evidence suggest that the structure of the semantic representation is spatial (geometrical) (Peter Gärdenfors). Furthermore, the research on the attentional mechanisms also point to the spatial, supramodal representation of space (Rob van der Lubbe). Recently, it has been proposed that the grid cells system in entorhinal cortex can serve a role of navigating through the cognitive spaces (Jacob Bellmund).
